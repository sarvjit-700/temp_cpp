...
void  Bureaucrat::signForm(AForm& f)
{
    ...
    {
        f.beSigned(*this);
        std::cout << YELLOW << this->_name << " signed " << f.getAFormName() << RESET << std::endl;
    }
    catch(const std::exception& e)
    {
        std::cout << RED<< this->_name << " couldn't sign " << f.getAFormName() 
...
void  Bureaucrat::executeForm(AForm const & form) const
{
    ...
    {
        std::cout << RED << this->_name << " couldn't execute "  << form.getAFormName() 
                << " because " << e.what() << RESET << std::endl;
    }
